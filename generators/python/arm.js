Blockly.Python['arm'] = function(block) {
  ...
  code += Blockly.readFile("../blockly/generators/python/scripts/arm.py");
...
Blockly.Python['arm_named_pose'] = function(block) {
  ...
  code += Blockly.readFile("../blockly/generators/python/scripts/arm_named_pose.py");
...
Blockly.Python['pose'] = function(block) {
  ...
  code += Blockly.readFile("../blockly/generators/python/scripts/pose.py");
...
Blockly.Python['arm_joint_target'] = function(block) {
  ...
  code += Blockly.readFile("../blockly/generators/python/scripts/arm_joint_target.py");
